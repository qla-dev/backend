...
class LoadDraftController extends CrudController
{
    ...
    protected function rules(bool $updating = false): array
    {
        return [
            ...
            'transport_type' => ['nullable', 'in:road,air,sea'],
            ...
            'pickup_address' => ['nullable', 'string', 'max:255'], 'pickup_port' => ['nullable', 'string', 'max:255'], 'pickup_latitude' => ['nullable', 'numeric', 'between:-90,90'], 'pickup_longitude' => ['nullable', 'numeric', 'between:-180,180'],
            ...
            'delivery_address' => ['nullable', 'string', 'max:255'], 'delivery_port' => ['nullable', 'string', 'max:255'], 'delivery_latitude' => ['nullable', 'numeric', 'between:-90,90'], 'delivery_longitude' => ['nullable', 'numeric', 'between:-180,180'],
