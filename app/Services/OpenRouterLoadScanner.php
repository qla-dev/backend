...
class OpenRouterLoadScanner
{
    ...
    private const STEP_FIELD_HINTS = [
        ...
        'pickup' => 'pickupCity, pickupPostalCode, pickupCountryCode, pickupAddress',
        'pickupDate' => 'pickupDate (and pickupTimeFrom/pickupTimeTo if a time window is given)',
        'delivery' => 'deliveryCity, deliveryPostalCode, deliveryCountryCode, deliveryAddress',
    ...
    private function documentSystemPrompt(array $current = []): string
    {
        return 'You read a freight document (a shipping order, rate confirmation, bill of lading, cargo manifest, or booking note) '
            ...
            .'Put leftover information that has no dedicated field (e.g. special handling instructions) in notes - never repeat the pallet count, dates, body type, or the booking reference inside notes since those already have their own fields. '
    ...
    private function normalizeResult(array $result): array
    {
        ...
        return [
            ...
            'pickupPostalCode' => $this->stringValue($result['pickupPostalCode'] ?? ''),
            ...
            'deliveryPostalCode' => $this->stringValue($result['deliveryPostalCode'] ?? ''),
    ...
    private function schema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'pickupPostalCode' => ['type' => 'string', 'description' => 'Postal/ZIP code, separate from the city name, or empty string if not stated.'],
                ...
                'deliveryPostalCode' => ['type' => 'string', 'description' => 'Postal/ZIP code, separate from the city name, or empty string if not stated.'],
