...
class SubscriptionPackageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $features = [
            ['key' => 'freight_exchange', 'title' => 'Freight Exchange', 'description' => 'Browse and post loads on the open freight marketplace to match cargo with available capacity in real time.', 'icon' => 'Boxes', 'roles' => ['driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ['key' => 'load_tracking', 'title' => 'Tracking My Loads', 'description' => 'Track every one of your shipments in real time, from pickup all the way to proof of delivery.', 'icon' => 'Package', 'roles' => ['user', 'driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ['key' => 'live_map', 'title' => 'Live Web GPS Map', 'description' => 'See your fleet and active shipments moving on a live map at all times.', 'icon' => 'Map', 'roles' => ['user', 'driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ['key' => 'fleet_management', 'title' => 'Fleet Management', 'description' => 'Register vehicles, assign drivers, and manage your entire fleet from one workspace.', 'icon' => 'Truck', 'roles' => ['driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ...
            ['key' => 'analytics', 'title' => 'Analytics Dashboard', 'description' => 'Track performance, revenue, and operational KPIs with real-time analytics.', 'icon' => 'BarChart3', 'roles' => ['user', 'driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ['key' => 'network', 'title' => 'Business Network', 'description' => 'Discover and connect with verified carriers, shippers, and logistics partners.', 'icon' => 'Globe', 'roles' => ['user', 'driver', 'company', 'manager', 'dispatcher', 'customs_officer', 'superadmin', 'master']],
            ['key' => 'invoicing', 'title' => 'Invoicing & Finance', 'description' => 'Generate invoices, track payments, and manage the financial side of every shipment.', 'icon' => 'Banknote', 'roles' => ['company', 'manager', 'finance', 'superadmin', 'master']],
            ['key' => 'team_management', 'title' => 'Team & Permissions', 'description' => 'Invite teammates, assign roles, and control who can access what inside your company workspace.', 'icon' => 'Users', 'roles' => ['company', 'manager', 'superadmin', 'master']],
