...
<head>
    ...
    <title>Your SmartFreight account is ready</title>
</head>
<body style="margin:0;background:#f8fafc;color:#0f172a;font-family:Arial,sans-serif;">
    <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;padding:32px;">
            <h1 style="margin:0 0 16px;font-size:24px;">Welcome to SmartFreight</h1>
            <p>Hello {{ $customerName }},</p>
            <p>Your SmartFreight customer account has been authorized. Use these credentials for your first sign-in:</p>
            ...
            <p style="margin-bottom:0;color:#64748b;">SmartFreight</p>
        </div>
    </div>
</body>
</html>
